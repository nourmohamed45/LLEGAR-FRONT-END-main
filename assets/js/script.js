...
// Get Slider Items
let sliderImages = Array.from(document.querySelectorAll(".slider .container .image li img"));
...
document.querySelector(".slider .container .indicator").appendChild(indicatorContainer);
...
let bulletsArray = Array.from(document.querySelectorAll("#indicator-ul .bullet"));
...
function generateProduct(product) {
  ...
  cardsContainer.innerHTML = ProductUI.join("");
