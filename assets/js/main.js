...
window.addEventListener("click", (event) => {
  if (!event.target.matches('.active-header .profile img, #dropdownProfile, #dropdownProfile *')) {
...
let nameOfUser = document.querySelector("header .container .active-header .profile .name");
let emailOfUser = document.querySelector("header .container .active-header .profile .email");
...
if(localStorage.getItem("email")) {
  ...
  let messageBoxUsers = document.querySelectorAll(".main .right-body .users .user");
  messageBoxUsers.forEach((user) => {
    user.addEventListener("click", () => {
      ...
      let inputMessage = SubmainMessageBox.querySelector(".message-box-footer input");
      let messageContainer = SubmainMessageBox.querySelector(".messages-container");
      ...
      SubmainMessageBox.querySelector(".message-box-footer .fa-paper-plane").addEventListener("click", () => {
        sendMessage();
      });
  ...
  let messageMainHeader = document.querySelector(".message-box .message-header");
...
function ShowUserReviewPopUp(){
  ...
  let sendMessage = () => {
    let userTextReview = document.querySelector("section .popup-outer form textarea").value;
    ...
    if (userTextReview === "" || !activeStarPopup) {
      ...
      localStorage.setItem("activeStarPopup", document.querySelector("li.active-star-popup .star-num").innerHTML);
  ...
  let applyUserReviewPopup = document.querySelector("section .popup-outer form button.apply");
  ...
  let cancelUserReviewPopup = document.querySelector("section .popup-outer form button.cancel");
